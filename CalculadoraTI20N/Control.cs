        ...
        public void Operacao()
        {
            ...
            do
            {
                ...
                switch (opcao)
                {
                    ...
                    case 2:
                        Coletar();
                        Console.WriteLine(" A soma dos valores digitados é: " + mod.Subtrair());
                        break;

                    case 3:
                        Coletar();
                        Console.WriteLine(" A soma dos valores digitados é: " + mod.Multiplicar());
                        break;
                    ...
                    case 4:
                        ...
                        if (mod.Dividir() == -1)
                        {
                            ...
                            Console.WriteLine(" A soma dos valores digitados é: " + mod.Dividir());
                        }
                        else
                        {
